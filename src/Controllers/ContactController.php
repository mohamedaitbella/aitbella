...
use Aitbella\Cosmed\Exports\ContactExport;
use Aitbella\Cosmed\Traits\ConfigurationTrait;
use Aitbella\Cosmed\Mail\ContactRegistered;
use Aitbella\Cosmed\Requests\StoreContactRequest;
use Aitbella\Cosmed\Models\Contact;
use Aitbella\Cosmed\Models\Destinataire;
use Aitbella\Cosmed\Models\Pays;
...
class ContactController extends Controller
{
    ...
    {   
        ...
        return view("cosmed::contact.index",["pays" =>$pays,"destinataire"=>$destinataire]);
    }
    ...
    public function store(StoreContactRequest $request)
    {
        ...
        return  Redirect::back()->with('message_remercions', trans('cosmed::fr.message_remercions'));
    }
    ...
    public function show()
    {
        ...
        return view("cosmed::contact.show",["contacts"=>$contacts]);
    }
